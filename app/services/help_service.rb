class HelpService
  def self.call
    ...
    response += ">Remove o link baseado no ID dele\n\n"
    response += "*Remova ID*\n"
    ...
    response += ">Lista os link, perguntas e respostas com aquela hashtag\n\n"
    response += "*Perguntas e Respostas*\n"
    response += ">Mostra a lista de perguntas e respostas\n\n"
    response += "*Links adicionados*\n"
    response += ">Mostra a lista de links\n\n"
  end
end
